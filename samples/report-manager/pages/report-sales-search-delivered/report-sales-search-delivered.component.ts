...
@Component({
  selector: 'app-report-sales-search-delivered',
  templateUrl: './report-sales-search-delivered.component.html',
  styleUrls: ['./report-sales-search-delivered.component.scss'],
  providers: [HttpClient],
})
export class ReportSalesSearchDelivered {
  searchText: string = '';
