...
export class ReportSalesGeneralSales {
  ...
  getList() {
    ...
    this._reportApiService.salesGeneralSales(this.filter).subscribe({
      next: (data: any) => {
        this.reportState.reportState.sales.generalSales.list = { data: data.sales.data, total: data.length }
      },
      error: (e) => {
        console.log('error loading data', e)
      },
  ...
  async exportExcel() {
    ...
    const list = this.reportState.reportState.sales.generalSales.filter.data.length > 0 ? this.reportState.reportState.sales.generalSales.filter.data : this.reportState.reportState.sales.generalSales.list.data
