...
@Component({
  selector: 'app-ondemand-close-orders',
  templateUrl: './ondemand-close-orders.component.html',
  styleUrls: ['./ondemand-close-orders.component.scss']
})
export class OndemandCloseOrdersComponent {
  ...
  excecute() {
    this.confirmationService.confirm({
      ...
      accept: () => {
        this.loading = true;
        this._onDemandManagerApiService.closeOrders().subscribe({
          next: (data) => {
