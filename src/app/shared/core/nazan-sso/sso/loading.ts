export function CreateLoading() {
  if (window['LOADING' as keyof typeof window]) return;
...
`;
  ...
  // window['LOADING' as keyof typeof window] = async function (
  //   value: boolean = true,
  //   msg: string = 'cargando'
  // ) {
  //   const sdom = window['S' as keyof typeof window] ? true : false;
